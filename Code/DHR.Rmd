...
#ALL items - forecasting with DHR
...
# glance(fit)
write.csv(merged_future_all,"../Data/merged_future_all_DHR.csv", row.names=FALSE)


# Forecast
fc <- forecast(fit, new_data =  merged_future_all)

write.csv(fc,"../Data/fc_all_DHR.csv", row.names=FALSE)
...
# metrics <- fc |> accuracy(sales_test_validation_long)
write.csv(metrics,"../Data/metrics_DHR_all.csv", row.names=FALSE)
write.csv(metrics_by_product,"../Data/metrics_by_product_DHR_all.csv", row.names=FALSE)
